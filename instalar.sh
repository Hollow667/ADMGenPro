...
funcao_idioma () {
msg -bar2
declare -A idioma=( [1]="en English" [2]="fr Franch" [3]="de German" [4]="it Italian" [5]="pl Polish" [6]="pt Spanish" [8]="tr Turkish" )
for ((i=1; i<=12; i++)); do
...
echo -e " thony / menu / adm " && msg -verm "$(source trans -b pt:${id} "Reinicie su servidor para concluir la instalación"|sed -e 's/[^a-z -]//ig')"
msg -bar2
}
ofus () {
unset txtofus
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   ...
   echo "${SCPdir}/menu" > /usr/bin/thony && chmod +x /usr/bin/thony
