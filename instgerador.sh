...
echo -ne "\033[1;33mDescargando Archivo \033[0;34m[$arqx] "
...
echo -e "\033[1;31m Perfecto, Use el Comando \033[1;32mgerar.sh; gerar o \033[1;32mgenplus \033[1;31mpara Administrar Sus Keys y
