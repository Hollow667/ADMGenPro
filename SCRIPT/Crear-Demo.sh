...
echo -e "\033[1;91m[2]-\033[1;97mContraseña para usuario $name: \033[0;37m"; read -p "Contraseña: 》" pass
echo -e "\033[1;91m[3]-\033[1;97mTiempo de Duración En Minutos: \033[0;37m"; read -p "Duración: 》" tmp
if [ "$tmp" = "" ]; then
tmp="30"
