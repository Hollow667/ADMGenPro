...
#os.system ("clear")
def usage():
    print("GENERADOR_BIN.py version:{}".format(version))
    print("")
    print("\033[1;31m               +------------------------------+")
    ...
    print("+---------------+")
    print("")
    print("\033[1;34m     python2 GENERADOR_BIN.py -b     [Opciones de uso]")
    print("     python2 GENERADOR_BIN.py -h     Mensaje de ayuda")
    print("\033[1;31m")
    print("+-----------------+")
    ...
    print("")
    print("\033[1;34m     python2 GENERADOR_BIN.py -b 406032xxxxxxxxxx -u 20 -d -c ")
    print("")
    print("\033[0m")
    print("\033[1;31m")
    print("+----------------+")
