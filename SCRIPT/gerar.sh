...
echo -e "\033[1;32m[b] > \033[0;33mINSTALACIÓN ADM-PLUS\033[0m"
msg -bar
...
links_inst  () {
echo -e "\e[97m\033[1;41m   =====>>►► LINKS INSTALL SCRIPT ADM•PLUS ◄◄<<=====   \033[1;37m"
msg -bar
echo -e "\033[1;37mapt-get update -y; apt-get upgrade -y; wget https://raw.githubusercontent.com/ThonyDroidYT/ADM-Ultimate-Plus/master/instalar.sh; chmod 777 instalar.sh* && ./instalar.sh"
msg -bar
read -p "Enter para Finalizar"
}
...
echo -e "\033[1;32m[5] \033[1;31m> \033[1;37mMENU BOT"
...
read foo
bot_gen;;
3)echo -e "\033[1;32m[2] \033[1;31m> \033[1;37mINICIAR/PARAR BOT" && read foo && bot_gen;;
...
info_sys () {
msg -bar
echo -e "\e[97m\033[1;41m        =====>>►►  GEN ADM•PLUS ◄◄<<=====         \033[1;37m"
msg -bar
