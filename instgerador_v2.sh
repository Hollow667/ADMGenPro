...
echo -e "\033[0;34m===========\033[0;31mKEY GENERATOR PLUS BY @Thony_DroidYT\033[0;34m===========\033[0m"
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://www.dropbox.com/s/l6iqf5xjtjmpdx5/trans &> /dev/null
...
echo -e "\033[1;33m Perfecto, Use el Comando \033[1;31mgerar.sh o gerar o genplus
\033[1;33mpara Administrar Sus Keys y Actualizar la Base del servidor"
echo -e "\033[0;34m======================================================\033[0m"
} || {
echo -e "\033[0;34m======================================================\033[0m"
